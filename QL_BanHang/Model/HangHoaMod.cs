...
namespace QL_BanHang.Model
{
    class HangHoaMod
    {
        ...
        {
            cmd.CommandText = "Update tb_HangHoa set TenHang =  N'" + hhObj.TenHangHoa + "',  DonGia = " + hhObj.DonGia + ", SoLuong = " + hhObj.SoLuong + " Where MaHang = '" + hhObj.MaHangHoa + "'";
            cmd.CommandType = CommandType.Text;
            cmd.Connection = con.Connection;
            try
            {
        ...
        public bool DelData1(string ma)
        {
            cmd.CommandText = "Delete tb_HangHoa Where MaHang = '" + ma + "'";
            cmd.CommandType = CommandType.Text;
            cmd.Connection = con.Connection;
