...
namespace QL_BanHang.View
{
    public partial class frmHoaDon : Form
    {
        ...
        private void frmHoaDon_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("select * from tb_thanhtoan", con);
        ...
        private void bingding()
        {
            ...
            datengaylap.DataBindings.Add("Text", dtgvDSHD.DataSource, "NgayLap");

            //txtNhanVien.DataBindings.Clear();
            //txtNhanVien.DataBindings.Add("Text", dtgvDSHD.DataSource, "TenNV");

            cbnhanvien.DataBindings.Clear();
            cbnhanvien.DataBindings.Add("Text", dtgvDSHD.DataSource, "TenNV");
        ...
        private void clearData()
        {
            ...
            datengaylap.Text = DateTime.Now.Date.ToShortDateString();
            LoadcmbKhachHang();
            LoadcmbNhanVien();
        }
        ...
        private void addData(HoaDonObj hdObj)
        {
           ...
           // hdObj.NgayLap = txtNgayLap.Text.Trim();
            hdObj.NgayLap = datengaylap.Text.Trim();
            // hdObj.NguoiLap = txtNhanVien.Text.Trim();

            hdObj.NguoiLap = cbnhanvien.Text.Trim();
        ...
        private void cmbHH_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                double gia = double.Parse(dt.Rows[0][5].ToString());
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.Yes)
            {
                if (hdCtr.DelData1(txtMa.Text.Trim()))
                    MessageBox.Show("Xóa thành công!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                else
                    MessageBox.Show("Xóa không thành công!", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        private void txtMa_Leave(object sender, EventArgs e)
        {
            ...
            if (ctr.Text.Trim().Length == 0)
                this.errorProvider1.SetError(txtMa, "Ban phai nhap ma hoa don");
            else
